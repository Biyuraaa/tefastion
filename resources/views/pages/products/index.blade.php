              ...
              <div class="col-md-12">
                <div class="ibox">
                  <div class="ibox-title">
                    ...
                    <span class="pull-right">(<strong>{{ $products->count() }}</strong>) items</span>
                            ...
                            <td width="200">
                              <div class="cart-product-imitation">
                                <a href="{{ route('products.show', ['product' => $product->id]) }}">
                                  ...
                                  @else
                                  <img src="{{ asset('assets/img/' . $product->images->first()->image) }}" alt="{{ $product->name }}" class="img-fluid">                                  @endif
                                </a>
                              </div>
                            </td>
                            <td class="desc">
                              <h3>
                                <a href="{{ route('product', ['id' => $product->id]) }}" class="text-navy">
                                  {{ $product->name }}
                                </a>
                              </h3>
                              <p class="small">
                  ...
                  @endforeach
                  <div class="ibox-content">
                    <button class="btn btn-primary pull-right"><i class="fa fa-shopping-cart"></i> Checkout</button>
